    ...
    <View style={styles.container}>
      ...
      <ScrollView showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.header}>
          ...
          <Text style={styles.name}>Hallo {user?.name || 'Trainer'}</Text>
        ...
        <View style={styles.quickStats}>
          <View style={styles.quickStatItem}>
            ...
            <Text style={styles.quickStatLabel}>Kunden</Text>
          </View>
        </View>
...
const createStyles = (Colors: any) => StyleSheet.create({
  ...
  avatar: { width: 80, height: 80, borderRadius: 40, backgroundColor: Colors.surface, alignItems: 'center', justifyContent: 'center', marginBottom: Spacing.md, borderWidth: 2, borderColor: Colors.accent, position: 'relative' },
  editBadge: { position: 'absolute', bottom: 0, right: 0, backgroundColor: Colors.accent, width: 24, height: 24, borderRadius: 12, alignItems: 'center', justifyContent: 'center' },
  ...
  roleBadge: { backgroundColor: Colors.accent, paddingHorizontal: Spacing.md, paddingVertical: Spacing.xs, borderRadius: BorderRadius.full },
  roleText: { color: Colors.text, fontSize: 14, fontWeight: '500' },
  quickStats: { flexDirection: 'row', justifyContent: 'center', paddingVertical: Spacing.lg, marginHorizontal: Spacing.lg, marginTop: Spacing.md, backgroundColor: Colors.surface, borderRadius: BorderRadius.md, borderWidth: 1, borderColor: Colors.border },
  quickStatItem: { alignItems: 'center' },
  quickStatValue: { fontSize: 22, fontWeight: '700', color: Colors.accent },
  ...
  modalAvatar: { width: 100, height: 100, borderRadius: 50, backgroundColor: Colors.surface, alignItems: 'center', justifyContent: 'center', borderWidth: 2, borderColor: Colors.accent },
